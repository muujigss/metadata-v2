...
const validationTab1Schema = Yup.object({
  ...
  tab1_database_location: Yup.string().required("Мэдээллийн сангийн байршил оруулна уу."),
  tab1_resource_location: Yup.string().required("Мэдээллийн сангийн нөөцийн байршил оруулна уу."),
  ...
  // tab1_file_type_info: Yup.string().required("Мэдээллийн сангийн файлын сангийн мэдээлэл (төрөл, тоо, хэмжээ, формат) оруулна уу."),
