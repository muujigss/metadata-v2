...
const TableDetail = ({ data }: { data: ITable }) => {
  ...
  return (
    <Card className="mx-auto flex self-stretch justify-between mt-2 bg-[#080812] border-none">
      <div className="relative overflow-x-auto ">
        <table className="site-table w-full text-left rtl:text-right text-white">
          <thead className=" text-white uppercase bg-transparent p-3 text-text-body-medium2">
            <tr>
          ...
          <tbody className=" text-text-body-medium2 bg-transparent">
            <tr className="bg-transparent text-white border-b dark:border-table-border">
              <th
                scope="row"
            ...
            <tr className="bg-transparent text-white border-b dark:border-gray-700">
              <th
                scope="row"
                className="px-6 py-2 font-medium text-blue-500 whitespace-nowrap dark:text-white"
              >
                ...
                {data?.source?.length > 0 &&
                  data?.source.map((item, i) => (
                    <div key={i} className="m-1">
                      <Kbd className=" font-thin text-white bg-transparent">
                        {libSources?.find(
